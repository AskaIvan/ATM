...
public class bank {
    public static void main (String args []){
        ...
        JOptionPane.showMessageDialog(null, "Selamat Darang\n ANJUNGAN TUNAI MANDIRI\n BNI SYARIAH-MAGETAN\n\n Masukkan 4 Digit PIN Anda !", "WELCOME", 1);
        try {
            do {                
                str = JOptionPane.showInputDialog(null, "Masukkan 4 Digit PIN Anda:", "ATM BNI SYARIAH-MAGETAN", 0);
                    ...
                    do {                        
                        ...
                        switch (choice){
                            case 1 : 
                                ...
                                z=JOptionPane.showConfirmDialog(null,"Melanjutkan transaksi lain?","ATM BNI SYARIAH-MAGETAN", JOptionPane.YES_NO_OPTION,3);
                                if (z==0)
                                    break;
                                else
                                    JOptionPane.showMessageDialog(null, "Terimakasih telah menggunakan ATM BNI SYARIAH-MAGETAN, ambil kartu ATM Anda");
                                System.exit(0);
                            case 2 :
                            ...
                            case 5 :
                                ...
                                if (z==0){
                                    ...
                                    break;
                                default: JOptionPane.showMessageDialog(null,"Pilihan menu ersedia\nSilahkan ulangi lagi","ERROR",0);
                        }
                    } while (1==1);
